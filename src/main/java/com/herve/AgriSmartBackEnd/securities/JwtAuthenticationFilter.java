...
import com.herve.AgriSmartBackEnd.repositories.RevokedTokenRepo;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        System.out.println("Header Authorization: " + authHeader); //pour le debogage
        final String jwt;
        ...
        System.out.println("Token extrait: " + jwt); //pour le debogage
